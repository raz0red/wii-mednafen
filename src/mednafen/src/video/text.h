...
uint32 DrawTextTransShadow(uint16 *dest, int pitch, uint32 width, const UTF8 *textmsg, uint32 fgcolor, uint32 shadcolor, int centered, uint32 which_font = MDFN_FONT_9x18_18x18);
