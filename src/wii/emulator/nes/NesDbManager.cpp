  ...
  WII_BUTTONS[WII_CONTROLLER_COUNT][WII_MAP_BUTTON_COUNT] =
{
  ...
  },
  {
    { "Plus",   WPAD_BUTTON_PLUS,       NES_MAP_START  },
    { "Minus",  WPAD_BUTTON_MINUS,      NES_MAP_SELECT },
    { "2",      WPAD_BUTTON_2,          NES_MAP_NONE   }, 
    { "1",      WPAD_BUTTON_1,          NES_MAP_NONE   },
  ...
  },
  {
    ...
    { "R",      WPAD_CLASSIC_BUTTON_FULL_R,   NES_MAP_NONE   },
    { "L",      WPAD_CLASSIC_BUTTON_FULL_L,   NES_MAP_NONE   },
    { "zR",     WPAD_CLASSIC_BUTTON_ZR,       NES_MAP_NONE   },
    { "zL",     WPAD_CLASSIC_BUTTON_ZL,       NES_MAP_NONE   }
  },
  {
    ...
    { "R",      PAD_TRIGGER_R,                NES_MAP_NONE   },
    { "L",      PAD_TRIGGER_L,                NES_MAP_NONE   },
    { NULL,     0,                            NES_MAP_NONE   },
    { NULL,     0,                            NES_MAP_NONE   },
    { NULL,     0,                            NES_MAP_NONE   },
  }
